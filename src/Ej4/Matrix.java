...
public class Matrix {
	...
	private void showDataMatrix(StringBuilder matrix, int numberOfProcess) {
	...
	private void showUtilizationMatrix(StringBuilder matrix, int numberOfProcess) {
		showDataMatrix(matrix, numberOfProcess);
	}
	...
	public void show(int matrixType) {
		...
		switch (matrixType) {
			...
			case UTILIZATION:
				...
				showUtilizationMatrix(matrix, numberOfProcess);
				break;
			case EVENTS:
				matrix.append("	|	");
